...
def test_delete_index_single_without_code_422(client):
    c, _ = client
    r = c.post("/api/admin/quotes/realtime/indices/delete", json={"scope": "single"})
    assert r.status_code == 422


def test_delete_index_single_ok(client):
    c, mock_db = client
    chain = MagicMock()
    ...
    r = c.post(
        "/api/admin/quotes/realtime/indices/delete",
        json={
            "scope": "single",
            "code": "000001",
