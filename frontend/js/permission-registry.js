...
window.PERMISSION_REGISTRY = [
  ...
  { code: 'channel.analyze.tab.stock_ai.btn.export', name: '导出个股分析', level: 3, parent_code: 'channel.analyze.tab.stock_ai', channel_code: 'analyze', sort_order: 15 },
