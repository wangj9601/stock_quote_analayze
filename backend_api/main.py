...
try:
    from .stock.market_review_routes import router as market_review_router
    print("market_review_router 导入成功")
except ImportError as e:
    print(f"market_review_router 导入失败: {e}")
    market_review_router = None

try:
    from .stock.board_fund_flow import router as board_fund_flow_router
    print("board_fund_flow_router 导入成功")
except ImportError as e:
    print(f"board_fund_flow_router 导入失败: {e}")
    board_fund_flow_router = None

try:
    from .stock.dragon_tiger import router as dragon_tiger_router
    print("dragon_tiger_router 导入成功")
except ImportError as e:
    print(f"dragon_tiger_router 导入失败: {e}")
...
try:
    from .stock.pattern_routes import router as pattern_router
    print("pattern_router 导入成功")
except ImportError as e:
    print(f"pattern_router 导入失败: {e}")
    pattern_router = None

try:
    from .stock.market_structure_routes import router as market_structure_router
    print("market_structure_router 导入成功")
except ImportError as e:
    print(f"market_structure_router 导入失败: {e}")
    market_structure_router = None

try:
    from .stock.gann_trend_routes import router as gann_trend_router
    print("gann_trend_router 导入成功")
except ImportError as e:
    print(f"gann_trend_router 导入失败: {e}")
    gann_trend_router = None
...
_include_router(app, market_structure_router, "波段与趋势")
_include_router(app, gann_trend_router, "江恩趋势")
