...
PERMISSION_REGISTRY: List[Dict[str, Any]] = [
    ...
    {"code": "channel.screening.tab.csb", "name": "通道突破", "level": 2, "parent_code": "channel.screening", "channel_code": "screening", "sort_order": 115},
    ...
    {"code": "channel.screening.tab.csb.btn.refresh", "name": "CSB刷新", "level": 3, "parent_code": "channel.screening.tab.csb", "channel_code": "screening", "sort_order": 10},
    ...
    {"code": "channel.analyze.tab.rs", "name": "个股相对强度分析", "level": 2, "parent_code": "channel.analyze", "channel_code": "analyze", "sort_order": 52},
    {"code": "channel.analyze.tab.rs.btn.query", "name": "查询相对强度", "level": 3, "parent_code": "channel.analyze.tab.rs", "channel_code": "analyze", "sort_order": 10},
    {"code": "channel.analyze.tab.rs.btn.batch", "name": "批量个股分析", "level": 3, "parent_code": "channel.analyze.tab.rs", "channel_code": "analyze", "sort_order": 20},
    ...
    {"code": "channel.analyze.tab.leader_mid.btn.gms_watchlist", "name": "加入GMS策略观察股", "level": 3, "parent_code": "channel.analyze.tab.leader_mid", "channel_code": "analyze", "sort_order": 20},
