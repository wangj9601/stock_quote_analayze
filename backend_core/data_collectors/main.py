...
scheduler.add_job(generate_hk_semiannual_data, 'cron', day_of_week='mon-fri', hour=17, minute=9, id='generate_hk_semiannual')
scheduler.add_job(generate_annual_data, 'cron', day_of_week='mon-fri', hour=16, minute=48, id='generate_annual')
scheduler.add_job(generate_hk_annual_data, 'cron', day_of_week='mon-fri', hour=17, minute=14, id='generate_hk_annual')
