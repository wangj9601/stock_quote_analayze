...
scheduler.add_job(collect_hk_realtime, 'cron', day_of_week='mon-fri', hour='9-12,13-22', minute='49', id='hk_realtime')
scheduler.add_job(collect_hk_historical, 'cron', day_of_week='mon-fri', hour=19, minute=59, id='hk_historical')
