...
if should_log_to_file():
    _handlers.append(logging.FileHandler(resolve_log_file('hk_monthly_generation.log'), encoding='utf-8'))
...
class HKMonthlyDataGenerator:
    ...
    def _log_operation_result(self, start_date: str, end_date: str, total_stocks: int, success_stocks: int):
        ...
        try:
            ...
            """), {
                'operation_type': 'generate_hk_monthly_from_weekly',
...
def main():
    ...
    parser = argparse.ArgumentParser(description='基于周线数据生成港股月线数据')
