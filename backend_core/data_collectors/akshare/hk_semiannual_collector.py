...
if should_log_to_file():
    _handlers.append(logging.FileHandler(resolve_log_file('hk_semiannual_generation.log'), encoding='utf-8'))
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description='基于季线数据生成港股半年线数据')
