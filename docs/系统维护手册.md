...
**文档版本：** 1.1  
**更新日期：** 2026 年 3 月  
**变更说明：** 合并 DEPLOYMENT_GUIDE、DEPLOYMENT_SUMMARY、DEPLOYMENT、系统部署架构图 至本手册，统一部署与维护说明。  
...
2. [环境与依赖](#2-环境与依赖)
3. [配置说明](#3-配置说明)（含 .env、Nginx、deploy_config.json）
...
`DEPLOYMENT_GUIDE.md`、`DEPLOYMENT_SUMMARY.md`、`DEPLOYMENT.md`、`系统部署架构图.md`。
